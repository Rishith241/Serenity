...
app.post('/api/chat', async (req, res) => {
  ...
  // Crisis check runs first, unconditionally — before we even check
  // whether the AI client is configured.
  if (containsCrisisLanguage(lastUserMsg)) {
    return res.json({ reply: CRISIS_RESPONSE, isCrisisResponse: true });
  }
